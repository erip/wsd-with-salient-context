...
export BASELINE_BPE_DATA="baseline_bpe_data"
...
if [ ! test -f ${TRAINING_DATA}/split{}/train.en-${TGT}.id ]; then 
...
test -f ${TRAINING_DATA}/split0/train.en-${TGT}.tfidf10 || (seq 0 3 | xargs -I{} bash -c 'lookup_context docid_to_tfidf_feats.en-${TGT}.pkl ${TRAINING_DATA}/split{}/train.en-${TGT}.id ${TRAINING_DATA}/split{}/train.en-${TGT}.tfidf10 ')
...
test -f ${TRAINING_DATA}/split0/train.en-${TGT}.yake10 || (seq 0 3 | xargs -I{} bash -c 'lookup_context docid_to_yake_feats.en-${TGT}.pkl ${TRAINING_DATA}/split{}/train.en-${TGT}.id  ${TRAINING_DATA}/split{}/train.en-${TGT}.yake10')
